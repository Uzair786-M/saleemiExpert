export const PortfolioCard = ({ item }) => (
  ...
  >
    ...
    <div style={{ position: "relative", zIndex: 1 }}>
      <span style={{ color: "#22d3ee", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em", display: "block", marginBottom: "0.5rem" }}>
        {item.category}
      </span>
      <h3 style={{ color: "#ffffff", fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.5rem" }}>
        {item.title}
      </h3>
      <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginTop: "0.75rem" }}>
        {item.tags.map((tag) => (
          <span key={tag} style={{
            fontSize: "0.7rem", padding: "2px 10px", borderRadius: "9999px",
